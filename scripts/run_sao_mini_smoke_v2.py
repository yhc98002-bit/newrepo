#!/usr/bin/env python3
"""Run the D-0037-bound three-call SAO mini-smoke on one idle an12 GPU."""
...
from backbones.contracts import GenerationRequest, sha256_file  # noqa: E402
...
def main() -> int:
    ...
    with lease:
        ...
        attempt_claim = consume_sao_mini_smoke_attempt(
            args.runtime_authorization,
            requested_run_dir=run_dir,
            live_config_path=args.config,
            git_commit=git_commit,
...
if __name__ == "__main__":
    os.environ.setdefault("PYTHONPYCACHEPREFIX", "/tmp/pxy1289-sao-live-pycache")
