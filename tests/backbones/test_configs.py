...
def test_core_launch_directly_freezes_the_sa3_project_runtime_closure() -> None:
    ...
    required = {
        ...
        REPOSITORY_ROOT / "src/backbones/sao_engineering_retry.py",
        REPOSITORY_ROOT / "src/backbones/sao_environment.py",
        REPOSITORY_ROOT / "src/backbones/sao_operational_claims.py",
